:root{
    ...
    --pix-svg-loader: url(../wp-content/themes/quattro/images/decor.svg);

    --pix-decor-img: url(../wp-content/themes/quattro/images/decor.svg);
